...
class OrdeneController extends Controller
{
    ...
    public function create()
    {
        ...
        $proveedores = Proveedore::pluck('proveedor','id');

        return view('ordene.create', compact('ordene','productos','proveedores'));
    }
    ...
    public function edit($id)
    {
        ...
        $productos = Producto::pluck('producto','id');
        $proveedores = Proveedore::pluck('proveedor','id');
        return view('ordene.edit', compact('ordene','productos','proveedores'));
    }
